...
| Federal Register | Appendix B exemplar (e.g., 80 Fed. Reg. 56577 (2015) codifying CFPB rule) | Federal Register heading remains to be exercised; document metadata needs ahead of fixture creation. | `type="regulation"`, `container-title="Fed. Reg."`, `volume`, `page`, `issued`, `note` for codification | **Planned fixture** – add tracking TODO. |
