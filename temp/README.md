...
- **2025-11-03** — Short-form restatement guardrails: adjusted the short-form layout in `texas-greenbook-15th-edition.csl` so repeated Texas statutes (Greenbook 15th ed. 24, 34), administrative rules (Greenbook 15th ed. 76–78), and Texas/Federal procedural rules (Greenbook 15th ed. 61–65) restate their full authority text instead of collapsing to `Id.`. Confirmed the behavior with the full note suite (`temp/test-logs/20251103T152401Z_notes_full-suite.txt`).
